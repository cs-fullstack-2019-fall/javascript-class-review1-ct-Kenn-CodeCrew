...
function main() {
    let arrayOfNames = ["Kenn", "Kevin", "Erin"];
    let arrayOfObjects = [];

    arrayOfNames.forEach(
        function(eachElementInTheArrayOneAfterTheOther)
        {
            let tempUser = new BankAccountUser(eachElementInTheArrayOneAfterTheOther);
            arrayOfObjects.push(tempUser);
        }
    );
